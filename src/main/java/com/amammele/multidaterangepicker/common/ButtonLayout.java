...
public class ButtonLayout extends LinearLayout implements View.OnClickListener {
    ...
    public ButtonLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdButtonLayoutStyle);
    }
    ...
    public ButtonLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, R.attr.mdButtonLayoutStyle,
    ...
    void initialize() {
        ...
        setPadding(res.getDimensionPixelSize(R.dimen.md_button_bar_padding_start),
                res.getDimensionPixelSize(R.dimen.md_button_bar_padding_top),
                res.getDimensionPixelSize(R.dimen.md_button_bar_padding_end),
                res.getDimensionPixelSize(R.dimen.md_button_bar_padding_bottom));

        final LayoutInflater inflater = (LayoutInflater) context.getSystemService(
                Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.md_button_pannel_layout, this, true);
