...
class DayPickerView extends ViewGroup {
    ...
    public DayPickerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.mdDayPickerStyle);
    }
    ...
    public DayPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, defStyleAttr,
        ...
        final int monthTextAppearanceResId = a.getResourceId(
                R.styleable.DayPickerView_mdMonthTextAppearance,
                R.style.MDMonthLabelTextAppearance);
        // verified
        final int dayOfWeekTextAppearanceResId = a.getResourceId(
                R.styleable.DayPickerView_mdWeekDayTextAppearance,
                R.style.MDWeekDayLabelTextAppearance);
        // verified
        final int dayTextAppearanceResId = a.getResourceId(
                R.styleable.DayPickerView_mdDateTextAppearance,
                R.style.MDDayTextAppearance);

        final ColorStateList daySelectorColor = a.getColorStateList(
                R.styleable.DayPickerView_mdDaySelectorColor);
