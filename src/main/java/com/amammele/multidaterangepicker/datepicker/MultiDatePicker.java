...
package com.amammele.multidaterangepicker.datepicker;
...
import com.amammele.multidaterangepicker.R;
import com.amammele.multidaterangepicker.common.DateTimePatternHelper;
import com.amammele.multidaterangepicker.utilities.AccessibilityUtils;
import com.amammele.multidaterangepicker.utilities.Config;
import com.amammele.multidaterangepicker.utilities.SUtils;
import com.amammele.multidaterangepicker.utilities.TextColorHelper;

import java.text.SimpleDateFormat;
import java.util.Calendar;
import java.util.Locale;

public class MultiDatePicker extends FrameLayout {
    private static final String TAG = MultiDatePicker.class.getSimpleName();
    ...
    private MultiDatePicker.OnDateChangedListener mDateChangedListener;
    ...
    public MultiDatePicker(Context context) {
        this(context, null);
    }

    public MultiDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdDatePickerStyle);
    }

    public MultiDatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initializeLayout(attrs, defStyleAttr, R.style.MultiDatePickerStyle);
    }
    ...
    private void initializeLayout(AttributeSet attrs,
        ...
        final TypedArray a = mContext.obtainStyledAttributes(attrs,
                R.styleable.MultiDatePicker, defStyleAttr, defStyleRes);
        ...
        ColorStateList headerTextColor
                = a.getColorStateList(R.styleable.MultiDatePicker_mdHeaderTextColor);
        ...
        if (SUtils.isApi_22_OrHigher()) {
            if (a.hasValueOrEmpty(R.styleable.MultiDatePicker_mdHeaderBackground)) {
                SUtils.setViewBackground(header,
                        a.getDrawable(R.styleable.MultiDatePicker_mdHeaderBackground));
            }
        } else {
            if (a.hasValue(R.styleable.MultiDatePicker_mdHeaderBackground)) {
                SUtils.setViewBackground(header, a.getDrawable(R.styleable.MultiDatePicker_mdHeaderBackground));
            }
        }

        int firstDayOfWeek = a.getInt(R.styleable.MultiDatePicker_mdFirstDayOfWeek,
                mCurrentDate.getFirstDate().getFirstDayOfWeek());

        final String minDate = a.getString(R.styleable.MultiDatePicker_mdMinDate);
        final String maxDate = a.getString(R.styleable.MultiDatePicker_mdMaxDate);
    ...
    private final OnClickListener mOnHeaderClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            SUtils.vibrateForDatePicker(MultiDatePicker.this);
    ...
    /**
     * Sets the minimal date supported by this {@link MultiDatePicker} in
    ...
    /**
     * Gets the minimal date supported by this {@link MultiDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
    ...
    /**
     * Sets the maximal date supported by this {@link MultiDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
     *
    ...
    /**
     * Gets the maximal date supported by this {@link MultiDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
    ...
    public CharSequence getAccessibilityClassName() {
        return MultiDatePicker.class.getName();
    }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link MultiDatePicker#onSaveInstanceState()}
         */
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(MultiDatePicker view, SelectedDate selectedDate);
    }
}
