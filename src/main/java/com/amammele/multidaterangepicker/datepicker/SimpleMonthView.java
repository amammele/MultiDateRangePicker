...
class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdMonthViewStyle);
    }
    ...
    private void init() {
        ...
        mDesiredMonthHeight = res.getDimensionPixelSize(R.dimen.md_date_picker_month_height);
        mDesiredDayOfWeekHeight = res.getDimensionPixelSize(R.dimen.md_date_picker_day_of_week_height);
        mDesiredDayHeight = res.getDimensionPixelSize(R.dimen.md_date_picker_day_height);
        mDesiredCellWidth = res.getDimensionPixelSize(R.dimen.md_date_picker_day_width);
        mDesiredDaySelectorRadius = res.getDimensionPixelSize(
                R.dimen.md_date_picker_day_selector_radius);
        mPaddingRangeIndicator = res.getDimensionPixelSize(R.dimen.md_month_view_range_padding);
    ...
    private void initPaints(Resources res) {
        final String monthTypeface = res.getString(R.string.md_date_picker_month_typeface);
        final String dayOfWeekTypeface = res.getString(R.string.md_date_picker_day_of_week_typeface);
        final String dayTypeface = res.getString(R.string.md_date_picker_day_typeface);

        final int monthTextSize = res.getDimensionPixelSize(
                R.dimen.md_date_picker_month_text_size);
        final int dayOfWeekTextSize = res.getDimensionPixelSize(
                R.dimen.md_date_picker_day_of_week_text_size);
        final int dayTextSize = res.getDimensionPixelSize(
                R.dimen.md_date_picker_day_text_size);
