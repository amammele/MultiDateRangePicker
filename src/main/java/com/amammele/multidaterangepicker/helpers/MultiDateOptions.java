package com.amammele.multidaterangepicker.helpers;
...
/**
 * Options to initialize 'MultiDatePicker'
 */
public class MultiDateOptions implements Parcelable {
    ...
    private MultiDateRecurrencePicker.RecurrenceOption mRecurrenceOption
    ...
    public MultiDateOptions() {
        // Nothing
    }

    private MultiDateOptions(Parcel in) {
        readFromParcel(in);
    }

    // Use 'LayoutTransition'
    @SuppressWarnings("unused")
    public MultiDateOptions setAnimateLayoutChanges(boolean animateLayoutChanges) {
    ...
    // when 'MultiDatePicker' is displayed
    public MultiDateOptions setPickerToShow(Picker picker) {
    ...
    // Activate pickers
    public MultiDateOptions setDisplayOptions(int displayOptions) {
    ...
    @SuppressWarnings("unused")
    public MultiDateOptions setDateParams(int year, int month, int dayOfMonth) {
        return setDateParams(year, month, dayOfMonth, year, month, dayOfMonth);
    }

    // Provide initial date parameters
    @SuppressWarnings("unused")
    public MultiDateOptions setDateParams(int startYear, int startMonth, int startDayOfMonth,
    ...
    // Provide initial date parameters
    @SuppressWarnings("unused")
    public MultiDateOptions setDateParams(@NonNull Calendar calendar) {
    ...
    // Provide initial date parameters
    @SuppressWarnings("unused")
    public MultiDateOptions setDateParams(@NonNull Calendar startCal, @NonNull Calendar endCal) {
    ...
    // Provide initial date parameters
    @SuppressWarnings("unused")
    public MultiDateOptions setDateParams(@NonNull SelectedDate selectedDate) {
    ...
    @SuppressWarnings("unused")
    public MultiDateOptions setDateRange(long minDate, long maxDate) {
        mMinDate = minDate;
        mMaxDate = maxDate;
        return this;
    }
    ...
    @SuppressWarnings("unused")
    public MultiDateOptions setTimeParams(int hourOfDay, int minute, boolean is24HourView) {
    ...
    @SuppressWarnings("unused")
    public MultiDateOptions setRecurrenceParams(MultiDateRecurrencePicker.RecurrenceOption recurrenceOption, String recurrenceRule) {
        ...
        if (recurrenceOption == null
                || (recurrenceOption == MultiDateRecurrencePicker.RecurrenceOption.CUSTOM
                && TextUtils.isEmpty(recurrenceRule))) {
            recurrenceOption = MultiDateRecurrencePicker.RecurrenceOption.DOES_NOT_REPEAT;
            recurrenceRule = null;
        } else if (recurrenceOption != MultiDateRecurrencePicker.RecurrenceOption.CUSTOM) {
            recurrenceRule = null;
        }
    ...
    @SuppressWarnings("unused")
    public MultiDateRecurrencePicker.RecurrenceOption getRecurrenceOption() {
        return mRecurrenceOption == null ?
                MultiDateRecurrencePicker.RecurrenceOption.DOES_NOT_REPEAT : mRecurrenceOption;
    }
    ...
    public MultiDateOptions setCanPickDateRange(boolean canPickDateRange) {
    ...
    public MultiDateOptions setToggleRangeWithoutLongPress(boolean toggleRangeWithoutLongPress) {
    ...
    public static final Creator<MultiDateOptions> CREATOR = new Creator<MultiDateOptions>() {
        public MultiDateOptions createFromParcel(Parcel in) {
            return new MultiDateOptions(in);
        }

        public MultiDateOptions[] newArray(int size) {
            return new MultiDateOptions[size];
        }
    };

    // Thrown if supplied 'MultiDateOptions' are not valid
