...
public abstract class MultiDatePickerListenerAdapter {
    /**
     * @param multiDateMaterialPicker MultiDateMaterialPickerMaterialPicker view
...
*                              be 'null' if 'recurrenceOption' is anything
     */
    public abstract void onDateTimeRecurrenceSet(MultiDateRangePicker multiDateMaterialPicker,
