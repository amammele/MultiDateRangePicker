package com.amammele.multidaterangepicker.recurrencepicker;
...
public class MultiDateRecurrencePicker extends FrameLayout
    ...
    public MultiDateRecurrencePicker(Context context) {
        this(context, null);
    }

    public MultiDateRecurrencePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdRecurrencePickerStyle);
    }

    public MultiDateRecurrencePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, R.attr.mdRecurrencePickerStyle,
                R.style.MultiDateRecurrencePickerStyle), attrs, defStyleAttr);
        initializeLayout();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MultiDateRecurrencePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, R.attr.mdRecurrencePickerStyle,
                R.style.MultiDateRecurrencePickerStyle), attrs, defStyleAttr, defStyleRes);
        initializeLayout();
    }
    ...
    void initializeLayout() {
        ...
        LayoutInflater.from(context).inflate(R.layout.md_recurrence_picker, this);
        ...
        final TypedArray a
                = context.obtainStyledAttributes(R.styleable.MultiDateRecurrencePicker);
        try {
            int headingBgColor = a.getColor(
                    R.styleable.MultiDateRecurrencePicker_mdHeaderBackground,
                    SUtils.COLOR_ACCENT);
            int pickerBgColor = a.getColor(
                    R.styleable.MultiDateRecurrencePicker_mdPickerBackground,
            ...
            mSelectedStateTextColor = a.getColor(
                    R.styleable.MultiDateRecurrencePicker_mdSelectedOptionTextColor,
                    SUtils.COLOR_ACCENT);
            mUnselectedStateTextColor = a.getColor(
                    R.styleable.MultiDateRecurrencePicker_mdUnselectedOptionsTextColor,
                    SUtils.COLOR_TEXT_PRIMARY);
            mPressedStateColor = a.getColor(
                    R.styleable.MultiDateRecurrencePicker_mdPressedOptionBgColor,
                    SUtils.COLOR_CONTROL_HIGHLIGHT);

            // Defaults to the included checkmark drawable
            mCheckmarkDrawable
                    = a.getDrawable(R.styleable.MultiDateRecurrencePicker_mdSelectedOptionDrawable);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link MultiDateRecurrencePicker#onSaveInstanceState()}
         */
