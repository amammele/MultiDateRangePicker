...
package com.amammele.multidaterangepicker.timepicker;
...
public class MultiDateTimePicker extends FrameLayout
        implements RadialTimePickerView.OnValueSelectedListener {

    private static final String TAG = MultiDateTimePicker.class.getSimpleName();
    ...
    public MultiDateTimePicker(Context context) {
        this(context, null);
    }

    public MultiDateTimePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdTimePickerStyle);
    }

    public MultiDateTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, R.attr.mdTimePickerStyle,
                R.style.MultiDateTimePickerStyle), attrs, defStyleAttr);
        initializeLayout();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MultiDateTimePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(SUtils.createThemeWrapper(context, R.attr.mdPickerStyle,
                R.style.MDPickerStyleLight, R.attr.mdTimePickerStyle,
                R.style.MultiDateTimePickerStyle), attrs, defStyleAttr, defStyleRes);
        initializeLayout();
    }
    ...
    private void initializeLayout() {
        ...
        final TypedArray a = mContext.obtainStyledAttributes(R.styleable.MultiDateTimePicker);
        ...
        ColorStateList headerTextColor = a.getColorStateList(R.styleable.MultiDateTimePicker_mdHeaderTextColor);
        ...
        if (SUtils.isApi_22_OrHigher()) {
            if (a.hasValueOrEmpty(R.styleable.MultiDateTimePicker_mdHeaderBackground)) {
                SUtils.setViewBackground(mHeaderView,
                        a.getDrawable(R.styleable.MultiDateTimePicker_mdHeaderBackground));
            }
        } else {
            if (a.hasValue(R.styleable.MultiDateTimePicker_mdHeaderBackground)) {
                SUtils.setViewBackground(mHeaderView,
                        a.getDrawable(R.styleable.MultiDateTimePicker_mdHeaderBackground));
            }
        }
    ...
    private final OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            SUtils.vibrateForTimePicker(MultiDateTimePicker.this);
        }
    };
    ...
    private final OnFocusChangeListener mFocusListener = new OnFocusChangeListener() {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (!hasFocus && mInKbMode && isTypedTimeFullyLegal()) {
                ...
                if (mOnTimeChangedListener != null) {
                    mOnTimeChangedListener.onTimeChanged(MultiDateTimePicker.this,
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(MultiDateTimePicker view, int hourOfDay, int minute);
    }
