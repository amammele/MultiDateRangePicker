...
public class RadialTimePickerView extends View {
    ...
    public RadialTimePickerView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.mdRadialTimePickerStyle);
    }
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mTextColor[HOURS] = a.getColorStateList(R.styleable.RadialTimePickerView_mdNumbersTextColor);
        mTextColor[HOURS_INNER] = a.getColorStateList(R.styleable.RadialTimePickerView_mdNumbersInnerTextColor);
        ...
        final ColorStateList selectorColors = a.getColorStateList(
                R.styleable.RadialTimePickerView_mdNumbersSelectorColor);
        ...
        mPaintBackground.setColor(a.getColor(R.styleable.RadialTimePickerView_mdNumbersBackgroundColor,
                ContextCompat.getColor(context, R.color.timepicker_default_numbers_background_color_material)));
        mPaintBackground.setAntiAlias(true);

        mSelectorRadius = res.getDimensionPixelSize(R.dimen.md_timepicker_selector_radius);
        mSelectorStroke = res.getDimensionPixelSize(R.dimen.md_timepicker_selector_stroke);
        mSelectorDotRadius = res.getDimensionPixelSize(R.dimen.md_timepicker_selector_dot_radius);
        mCenterDotRadius = res.getDimensionPixelSize(R.dimen.md_timepicker_center_dot_radius);

        mTextSize[HOURS] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_size_normal);
        mTextSize[MINUTES] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_size_normal);
        mTextSize[HOURS_INNER] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_size_inner);

        mTextInset[HOURS] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_inset_normal);
        mTextInset[MINUTES] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_inset_normal);
        mTextInset[HOURS_INNER] = res.getDimensionPixelSize(R.dimen.md_timepicker_text_inset_inner);
